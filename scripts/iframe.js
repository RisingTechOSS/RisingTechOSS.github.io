document.addEventListener('DOMContentLoaded', function () {
    const links = [
      ...
      { selector: 'ul#mobile-side-menu li a[href="#discover1"]', src: 'features.html' },
      { selector: 'ul#discover-dropdown li a[href="#discover2"]', src: 'about.html' },
      { selector: 'ul#mobile-side-menu li a[href="#about1"]', src: 'about.html' },
      { selector: 'a.nav_menu_item[href="#devices"]', src: 'devices.html' },
      { selector: 'ul#mobile-side-menu li a[href="#devices"]', src: 'devices.html' },
      { selector: 'ul#discover-dropdown li a[href="#wiki"]', src: 'wiki.html' },
      { selector: 'ul#mobile-side-menu li a[href="#wiki"]', src: 'wiki.html' },
      { selector: 'a.source_code_btn[href="#download"]', src: 'download.html' }, 
      { selector: 'ul#mobile-side-menu li a[href="#download"]', src: 'download.html' },
      { selector: 'a.nav_menu_item[href="#news"]', src: 'news.html' },
      { selector: 'ul#mobile-side-menu li a[href="#news"]', src: 'news.html' },
    ];
